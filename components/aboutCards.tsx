...
export function HistoryCard({title, text}: HistoryCardProps) {
    return(
        <article className="p-2.5 border border-[#1F1F1F] bg-[#0E1011] w-[142px] lg:w-[250px] rounded-xl">
...
export function ValueCard({title, text, imgSrc, imgAlt, mobileImgWidth, mobileImgHeight, dekstopImgWidth, dekstopImgHeight}: ValueCardProps) {
    return(
        <article className="p-2.5 lg:p-7 border border-[#1F1F1F] bg-[#0E1011] rounded-xl w-[142px] lg:w-[325px] h-[100px] lg:h-[185px]">
