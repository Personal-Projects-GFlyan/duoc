...
export default async function ServicesPage() {
    return(
        <main>
            {/* HISTÓRIA */}
            <section className="w-full pt-5 pb-10 lg:py-10 px-7 lg:px-10 h-[270px] lg:h-[425px] flex justify-center items-center">
                <Image src="/background.webp" alt="Hero Image"  priority fetchPriority="high" fill className="max-w-full max-h-[270px] lg:max-h-[425px]" sizes="100vw"/>
            ...
            {/* SERVIÇOS */}
            <section className="w-full min-h-screen bg-[#0B0E10] py-10 lg:py-14 xl:py-20 px-7 lg:px-10 flex justify-center items-center ">
            ...
            {/* CONTATO */}
            <section className="bg-[#06090B] w-full py-10 lg:px-10 lg:py-14 flex flex-col justify-center items-center px-7">
