...
export default async function ServiceInfos({params}: {params: Promise<{id: string}>}) {
    ...
    return(
        <>
            <section className="bg-[#07090A] w-full pt-5 pb-10 lg:py-10 px-7 lg:px-10 text-[#D8D8D8]">
                <h1 className="text-[23px] lg:text-[67px] font-bold mt-[75px]">{serviceInfos.nome}</h1>
                <p className="text-left text-[12px] lg:text-[22px] mt-2">{serviceInfos.descricao}</p>
