...
export default function HomePage() {
    ...
    return(
            <main>
                {/* Hero */}
                <section className="relative w-full h-[360px] md:h-[420px] lg:h-[650px] flex justify-center items-center">
                    <Image src="/hero-desktop.webp" alt="Hero Image" fill priority fetchPriority="high" className="" sizes="100vw"/>
                    <div className="absolute top-[125px] lg:top-[200px] w-full px-7 md:px-10 2xl:px-0 max-w-[1456px]">
                ...
                {/*Quem Somos*/}
                <section id="about" className="bg-[#07090A] w-full py-5 md:p-10 pb-8 flex justify-center items-center">
                    <div className="w-full max-w-[1456px]">
                        <h1 className="text-[#DAA520] text-[17px] md:text-[22px] text-center md:text-start font-medium">QUEM SOMOS</h1>
                        <div className="flex flex-col xl:flex-row justify-between pt-4 md:pt-0">
                            <section className="flex gap-7 md:gap-5 md:flex-col px-7 md:px-0">
                                <div className="md:relative">
                                    ...
                                    <div className="relative md:static flex flex-col md:flex-col-reverse">
                                        ...
                                        <h2 className="text-[#DAA520] text-[6px] md:text-[30px] font-bold md:absolute md:top-[58px]">Arquitetura e Engenharia</h2>
                                    </div>
                                </div>
                            ...
                            <div className="flex xl:flex-col gap-5 xl:gap-10 pt-6 pl-7 md:px-0 md:pt-10 xl:px-10 xl:pt-0 overflow-auto scrollbar-hide">
                ...
                {/*Fale Conosco*/}
                <section id="contact" className="bg-[#010101] w-full px-7 md:px-10 py-5 md:py-10 flex justify-center items-center">
                    <div className="w-full max-w-[1456px]">
                        ...
                        <div className="flex flex-col justify-center items-center lg:flex-row lg:justify-between">
                            <div className="lg:max-w-[501px]">
                                <h2 className="text-white font-bold mt-2 md:text-[30px]  lg:text-[39px]">
                                ...
                                <div className="grid grid-cols-2 lg:flex lg:justify-start items-center lg:items-start lg:flex-col mt-5 md:mt-14 lg:mt-5 gap-1 md:gap-5">
                                    {contactLabels.map((label, index)=>(
                                        <Link key={index} href={label.url}>
                                            <article className="flex h-[50px] md:h-auto w-[150px] md:w-auto">
                                                <div className="min-h-[35px] max-h-[35px] md:min-h-[50px] md:max-h-[50px] lg:min-h-[67.5px] lg:max-h-[67.5px] min-w-[35px] max-w-[35px] md:min-w-[50px] md:max-w-[50px] lg:min-w-[67.5px] lg:max-w-[67.5px] bg-[#DAA520] rounded-md flex justify-center items-center">
                            ...
                            <form action="/" method="POST" className="px-7 pb-7 pt-3.5 md:py-5 border border-[#1F1F1F] bg-[#0E1011] flex flex-col gap-3 rounded-lg md:max-w-[500px] md:justify-center mt-3 md:mt-14 lg:mt-0">
                                <div>
